...
getFlavorByIndex(originalFlavors, [29])
...
console.log(filterByWord(originalFlavors, 'Chocolate', 'chocolateFlavs'));
...
function getRandomFlavors(arr, size){
   ...
   let allFlavs = []
        allFlavs.push(...newFlavors, ...originalFlavors, ...seasonalFlavors, ...regionalFlavors) 
   console.log(getRandomFlavors(allFlavs, 31))
